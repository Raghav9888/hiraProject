                  ...
                  datasets: [
                      {
                          ...
                          fill: true,
                          pointBorderWidth: 1,
                          pointRadius: thisWeekData.map(() => 4),
                          pointHoverRadius: thisWeekData.map(() => 2),
                          pointBackgroundColor: thisWeekData.map(() => '#1F3BB3'),
                          pointBorderColor: thisWeekData.map(() => '#fff'),
                      },
                      {
                          label: 'Last week',
                          data: lastWeekData,
                          ...
                          fill: true,
                          pointBorderWidth: 1,
                          pointRadius: lastWeekData.map(() => 4),
                          pointHoverRadius: lastWeekData.map(() => 2),
                          pointBackgroundColor: lastWeekData.map(() => '#52CDFF'),
                          pointBorderColor: lastWeekData.map(() => '#fff'),
                      }
                  ]
              },
              options: {
              ...
              plugins: [{
                  afterDatasetUpdate: function (chart, args, options) {
                      ...
                      chart.data.datasets.forEach(ds => {
                          ul.innerHTML += `
            <li>
              <span style="background-color: ${ds.borderColor}"></span>
              ${ds.label}
            </li>
          `;
                      });
