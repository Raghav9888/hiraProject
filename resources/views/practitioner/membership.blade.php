                                ...
                                <div class="tab-pane fade" id="membershipDetail" role="tabpanel"
                                    ...
                                    <div class="container mt-5">
                                        @if($user->subscribed('default'))
                                            <form>
                                                <div class="mb-4">
                                                    <label class="form-label ">Membership Start Date: <span
                                                            class="fw-bold">{{date('M d, Y', strtotime($user->subscription('default')->created_at))}}</span></label>
                                                </div>

                                                <div class="mb-4">
                                                    <label class="form-label ">Membership Type: <span
                                                            class="fw-bold">{{$userPlan? $userPlan->name: null}}</span></label>
                                                </div>

                                                <div class="mb-4">
                                                    <label class="form-label ">Payment Status: <span
                                                            class="fw-bold">{{$user->subscription('default')->stripe_status === 'active'? "Paid": "Unpaid"}}</span></label>
                                                </div>

                                                <div class="mb-4">
                                                    <label class="form-label ">Subscription Status: <span
                                                            class="fw-bold">{{$user->subscription('default')->stripe_status}}</span></label>
                                                </div>

                                                <div class="mb-4">
                                                    <label class="form-label ">Renewal Date: <span
                                                            class="fw-bold">{{date('M d, Y', strtotime($user->subscription('default')->ends_at))}}</span></label>
                                                </div>
                                            ...
                                            <div class="row membership-plans">
                                                @forEach($plans as $p)
                                                    <div class="col-md-3">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <form action="{{route('membership.buy')}}"
                                                                      method="POST">
                                                                    @csrf
                                                                    <h4>{{$p->name}}</h4>
                                                                    <p>${{$p->price}} (+{{$p->tax_percentage}}% Tax)
                                                                        /{{$p->interval}}</p>
                                ...
                                <div class="tab-pane fade" id="professionalInformation" role="tabpanel"
                                    ...
                                    <div class="container mt-5">
                                        <form action="{{route('professionalServiceInformation')}}" method="post"
                                            ...
                                            <div class="mb-4 mt-4">
                                                <div class="d-lg-flex">
                                                    <label for="media" class="fw-bold">Certifications & Credentials
                                                        Upload
                                                        (If
                                                        applicable)</label>
                                                    <div class="ms-3">
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="certificationConfirmation">
                                                        I confirm that I hold all necessary certifications, credentials,
                                                        and
                                                        qualifications required to offer the modalities and services I
                                                        provide through The Hira Collective. I understand that I am
                                                        solely
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label">
                                                        ...
                                                        legitimacy, or delivery of my services. I take full
                                                        accountability
                                            ...
                                            <div class="mb-3">
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="complianceDeclaration">
                                                        ...
                                                        compliance, and any false or misleading information may result
                                                        in
                                            ...
                                            <div class="mb-3">
                                                <label for="licenseNumber" class="form-label">License/Certification
                                                    Number
                                                    (If applicable)</label>
                                ...
                                <div class="tab-pane fade" id="community" role="tabpanel" aria-labelledby="contact-tab"
                                    ...
                                    <form method="post" action="{{route('communityEngagement')}}">
                                        ...
                                        <div class="container mt-5">
                                            ...
                                            <div class="mb-4">
                                                <h5>Are you interested in contributing to blogs, workshops, or
                                                    events?</h5>
