                        ...
                        <div class="container">
                            <div class="mb-4 mt-4">
                                <ul class="nav nav-tabs" id="tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" id="clint-tab" data-bs-toggle="tab" href="#client"
                                           role="tab"
                                        ...
                                        <form method="post" action="{{ route('update_profile') }}"
                                            ...
                                            <div class="mb-4 pt-2">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        <button class="update-btn mb-2 addterm" data-type="IHelpWith">
                                                            Add
                                                            New Term
                                                        </button>
                                                    </div>
                                        ...
                                        <button class="update-btn mb-2">Add New Term</button> -->
                                            <div class="mb-4 select2-div">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        <button class="update-btn mb-2 addterm" data-type="HowIHelp">Add
                                                            New
                                                            Term
                                                        </button>
                                                    </div>
                                            ...
                                            <div class="mb-4 select2-div">
                                                <label for="specialities" class="fw-bold">Categories (only select
                                                    3)</label>
...
//                                                        'Weekends only - Every Sat & Sundays'
                                                        ...
                                                        <div class="col-md-4 col-sm-6 col-12 mb-3">
                                                            ...
                                                            <div class="store-time-input"
                                                                 id="store_time_<?= $index + 1; ?>"
                                                    ...
                                                    <div class="form-group flex-column d-flex align-items-start">
                                                        @if($googleAccount && $googleAccount->access_token && $googleAccount->refresh_token)
                                                            <form method="POST"
                                                                ...
                                                                @csrf
                                                                <button type="submit" class="export-btn">Disconnect
                                                                </button>
                                                            </form>
                                                        @else
                                                            <a href="{{ route('redirect_to_google') }}"
                                                               class="export-btn">
                                                                Connect to Google
                                                            </a>
                                                        @endif
