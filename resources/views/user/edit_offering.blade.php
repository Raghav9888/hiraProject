                                    ...
                                    <div class="tab-pane fade show active" id="offering" role="tabpanel"
                                            ...
                                            <div class="d-none mt-2" id="custom_hours" style="gap: 20px;">
                                                <div>
                                                    ...
                                                    <input type="datetime-local" class="form-control"
                                                           name="from_date" placeholder="" value="{{ $offering->from_date ? $offering->from_date : '' }}">
                                                </div>
                                                <div>
                                                    <label for="service-hours" class="fw-bold">To</label>
                                                    <input type="datetime-local" class="form-control" name="to_date"
                                                           placeholder="" value="{{ $offering->to_date ? $offering->to_date : '' }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col mb-4">
                                                ...
                                                <textarea class="form-control" name="email_template" id="email_template" placeholder="">{{$offering?->email_template}}</textarea>
                                    ...
                                    <div class="tab-pane fade" id="events" role="tabpanel" aria-labelledby="events-tab"
                                        ...
                                        <div class="my-4">
                                            ...
                                            <select id="specify" name="specify" class="form-select"
                                                ...
                                                <option value="one_time_event" {{$offering->event?->specify === 'one_time_event' ? 'selected' : ''}}>One time event</option>
                                                <option value="recurring_event" {{$offering->event?->specify === 'recurring_event' ? 'selected' : ''}}>Recurring event</option>
                                            </select>
                                        </div>

                                        <div class="mb-4 {{$offering->event?->specify === 'one_time_event' ?:'d-none'}} flex-column" id="date_and_time_div">
                                            <label for="service-hours" class="fw-bold">Date and time</label>
                                            <input type="datetime-local" class="form-control" placeholder="" name="date_and_time" value="{{$offering->event?->date_and_time}}">
                                        </div>

                                        <div class="mb-4 {{$offering->event?->specify === 'recurring_event' ?:'d-none'}} flex-column" id="recurring_day_div">
                                            <label class="fw-bold">Recurring Days</label>
                                            <select id="type" class="form-select" name="recurring_days">
                                                <option value="every_day" {{$offering->event?->recurring_days === 'every_day' ? 'selected':''}}>Every day</option>
                                                <option value="every_monday" {{$offering->event?->recurring_days === 'every_monday' ? 'selected':''}}>Every monday</option>
                                                <option value="every_tuesday" {{$offering->event?->recurring_days === 'every_tuesday' ? 'selected':''}}>Every tuesday</option>
                                                <option value="every_wednesday" {{$offering->event?->recurring_days === 'every_wednesday' ? 'selected':''}}>Every wednesday</option>
                                                <option value="every_thursday" {{$offering->event?->recurring_days === 'every_thursday' ? 'selected':''}}>Every thursday</option>
                                                <option value="every_friday" {{$offering->event?->recurring_days === 'every_friday' ? 'selected':''}}>Every friday</option>
                                                <option value="weekend_every_saturday_sunday" {{$offering->event?->recurring_days === 'weekend_every_saturday_sunday' ? 'selected':''}}>Weekends only - Every
                                                    Sat & Sundays
                                                </option>
                                            </select>
                                        </div>
                                        <div class="my-4">
                                            ...
                                            <select id="event-duration" name="event_duration" class="form-select">
                                                <option value="15 minutes" {{$offering->event?->event_duration === '15 minutes' ? 'selected':''}} >15 minutes</option>
                                                <option value="20 minutes" {{$offering->event?->event_duration === '20 minutes' ? 'selected':''}}>20 minutes</option>
                                                <option value="30 minutes" {{$offering->event?->event_duration === '30 minutes' ? 'selected':''}}>30 minutes</option>
                                                <option value="45 minutes" {{$offering->event?->event_duration === '45 minutes' ? 'selected':''}}>45 minutes</option>
                                                <option value="50 minutes" {{$offering->event?->event_duration === '50 minutes' ? 'selected':''}}>50 minutes</option>
                                                <option value="1 hour" {{$offering->event?->event_duration === '1 hour' ? 'selected':''}}>1 hour</option>
                                                <option value="1:15 hour" {{$offering->event?->event_duration === '1:15 hour' ? 'selected':''}}>1:15 hour</option>
                                                <option value="1:30 hour" {{$offering->event?->event_duration === '1:30 hour' ? 'selected':''}}>1:30 hour</option>
                                                <option value="1:45 hour" {{$offering->event?->event_duration === '1:45 hour' ? 'selected':''}}>1:45 hour</option>
                                                <option value="1:50 hour" {{$offering->event?->event_duration === '1:50 hour' ? 'selected':''}}>1:50 hour</option>
                                                <option value="2 hour" {{$offering->event?->event_duration === '2 hour' ? 'selected':''}}>2 hours</option>
                                                <option value="3 hour" {{$offering->event?->event_duration === '3 hour' ? 'selected':''}}>3 hour</option>
                                                <option value="4 hour" {{$offering->event?->event_duration === '4 hour' ? 'selected':''}}>4 hour</option>
                                                <option value="1 Month" {{$offering->event?->event_duration === '1 Month' ? 'selected':''}}>1 Month</option>
                                                <option value="2 Month" {{$offering->event?->event_duration === '2 Month' ? 'selected':''}}>2 Months</option>
                                                <option value="3 Month" {{$offering->event?->event_duration === '3 Month' ? 'selected':''}}>3 Months</option>
                                                <option value="4 Month" {{$offering->event?->event_duration === '4 Month' ? 'selected':''}}>4 Months</option>
                                            </select>
                                        </div>
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="sports" class="form-control"
                                                   placeholder="Type the available spots in numbers" name="sports" value="{{$offering->event?->sports}}">
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col mb-4">
                                                ...
                                                <input type="text" class="form-control"
                                                       placeholder="Please add the price for your offering"
                                                       name="client_price" value="{{$offering->event?->client_price}}">
                                            </div>
                                            <div class=" col mb-4">
                                                <label for="tax" class="fw-bold">Tax</label>
                                                <input type="text" class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col mb-4">
                                                <label for="type" class="fw-bold">Scheduling window (How far in
                                                    ...
                                                    they can book)</label>
                                                <select id="type" class="form-select" name="scheduling_window">
                                                    <option value="15 minutes" {{$offering->event?->scheduling_window === '15 minutes' ? 'selected':''}} >15 minutes</option>
                                                    <option value="20 minutes" {{$offering->event?->scheduling_window === '20 minutes' ? 'selected':''}}>20 minutes</option>
                                                    <option value="30 minutes" {{$offering->event?->scheduling_window === '30 minutes' ? 'selected':''}}>30 minutes</option>
                                                    <option value="45 minutes" {{$offering->event?->scheduling_window === '45 minutes' ? 'selected':''}}>45 minutes</option>
                                                    <option value="50 minutes" {{$offering->event?->scheduling_window === '50 minutes' ? 'selected':''}}>50 minutes</option>
                                                    <option value="1 hour" {{$offering->event?->scheduling_window === '1 hour' ? 'selected':''}}>1 hour</option>
                                                    <option value="1:15 hour" {{$offering->event?->scheduling_window === '1:15 hour' ? 'selected':''}}>1:15 hour</option>
                                                    <option value="1:30 hour" {{$offering->event?->scheduling_window === '1:30 hour' ? 'selected':''}}>1:30 hour</option>
                                                    <option value="1:45 hour" {{$offering->event?->scheduling_window === '1:45 hour' ? 'selected':''}}>1:45 hour</option>
                                                    <option value="1:50 hour" {{$offering->event?->scheduling_window === '1:50 hour' ? 'selected':''}}>1:50 hour</option>
                                                    <option value="2 hour" {{$offering->event?->scheduling_window === '2 hour' ? 'selected':''}}>2 hours</option>
                                                    <option value="3 hour" {{$offering->event?->scheduling_window === '3 hour' ? 'selected':''}}>3 hour</option>
                                                    <option value="4 hour" {{$offering->event?->scheduling_window === '4 hour' ? 'selected':''}}>4 hour</option>
                                                    <option value="1 Month" {{$offering->event?->scheduling_window === '1 Month' ? 'selected':''}}>1 Month</option>
                                                    <option value="2 Month" {{$offering->event?->scheduling_window === '2 Month' ? 'selected':''}}>2 Months</option>
                                                    <option value="3 Month" {{$offering->event?->scheduling_window === '3 Month' ? 'selected':''}}>3 Months</option>
                                                    <option value="4 Month" {{$offering->event?->scheduling_window === '4 Month' ? 'selected':''}}>4 Months</option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col mb-4">
                                                <label for="service-hours" class="fw-bold">Intake form
                                                    (Optional)</label>
                                                <input type="text" class="form-control" name="intake_form"
                                                       placeholder="enter your link" value="{{$offering->event?->intake_form}}">
                                            </div>
                                        </div>
                                        <div class="mb-4">
                                            <div class="form-check offering-check">
                                            ...
                                            <div class="col-md-6 mb-4 {{$offering->event?->is_cancelled ?'' : 'd-none' }}" id="cancellation_time">
                                                <label class="fw-bold">Cancellation time</label>
                                                <select id="type" class="form-select" name="cancellation_time_slot">
                                                    <option value="15 minutes" {{$offering->event?->cancellation_time_slot ==='15 minutes' ?'selected' : '' }}>15 minutes</option>
                                                    <option value="30 minutes">30 minutes</option>
                                                    <option value="45 minutes">45 minutes</option>
                                                    <option value="1 hour">1 hour</option>
                                                    <option value="2 hour">2 hour</option>
