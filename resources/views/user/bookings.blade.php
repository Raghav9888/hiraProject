@php use App\Models\Show;use Carbon\Carbon;use Illuminate\Support\Str; @endphp
                ...
                @forelse($bookings as $booking)
                    ...
                    <tr>
                        @if(isset($booking->shows_id) && $booking->shows_id)
                                ...
                                ?>
                            <td class="text-center">{{ $show->user->first_name ?? '' }} {{ $show->user->last_name ?? '' }}</td>
                            <td class="text-center">{{ $show->name ?? '-' }}</td>
                            <td class="text-center">{{ $show->show_type }}</td>
