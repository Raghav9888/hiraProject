                ...
                <div class="add-offering-dv">
                    ...
                    <form method="POST" action="{{route('update_discount', $discount->id)}}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" value="{{$discount->coupon_code}}" id="coupon_code" name="coupon_code" aria-describedby="emailHelp" placeholder="Coupon code">
                        </div>
                        <div class="mb-3">
                            <label for="floatingTextarea">Coupon description</label>
                            <textarea class="form-control" placeholder="Coupon description" name="coupon_description" id="coupon_description">{{$discount->coupon_description}}</textarea>
                        </div>
                        <div class="container">
                            <div class="mb-4">
                                ...
                                <div class="tab-content mt-3" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="general" role="tabpanel"
                                        ...
                                        <div class="mb-4">
                                            <div class="form-check offering-check">
                                                <input type="checkbox" class="form-check-input" {{$discount->apply_all_services? 'checked': ''}} id="apply_all_services" name="apply_all_services">
                                    ...
                                    <div class="tab-pane fade" id="availability" role="tabpanel"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" value="{{$discount->minimum_spend}}" class="form-control" placeholder="No minimum" name="minimum_spend" id="minimum_spend">
                                        </div>
                                        <div class="mb-4">
                                            <label for="coupne-amount">Maximum spend</label>
                                            <input type="text" value="{{$discount->maximum_spend}}" class="form-control" placeholder="No maximum" name="maximum_spend" id="maximum_spend">
                                        </div>
                                        <div class="mb-4">
                                            <div class="form-check offering-check">
                                                <input type="checkbox" {{$discount->individual_use_only? 'checked': ''}} class="form-check-input" id="individual_use_only" name="individual_use_only">
                                        ...
                                        <div class="mb-4">
                                            <div class="form-check offering-check">
                                                <input type="checkbox" class="form-check-input" {{$discount->exclude_sale_items? 'checked': ''}} id="exclude_sale_items" name="exclude_sale_items">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <select name="offerings" class="form-select">
                                                @foreach($offerings as $offering)
                                                    <option value="{{$offering->id}}" {{$discount->offerings == $offering->id? 'selected': ''}}>{{$offering->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-4">
                                            <label for="coupne-amount">Exclude services</label>
                                            <input type="text" value="{{$discount->exclude_services}}" class="form-control" placeholder="" id="exclude_services" name="exclude_services">
                                        </div>
                                        <div class="mb-4">
                                            <label for="coupne-amount">Email Restrictions</label>
                                            <input type="text" value="{{$discount->email_restrictions}}" class="form-control" placeholder="no restrictions" id="email_restrictions" name="email_restrictions">
                                    ...
                                    <div class="tab-pane fade" id="costs" role="tabpanel" aria-labelledby="costs-tab">
                                        <div class="col mb-3">
                                            ...
                                            <input type="number" value="{{$discount->usage_limit_per_coupon}}" class="form-control" placeholder="Unlimited usage" name="usage_limit_per_coupon" id="usage_limit_per_coupon">
                                        </div>
                                        <div class="col mb-3">
                                            <label for="booking">Usage limit to x items</label>
                                            <input type="number" value="{{$discount->usage_limit_to_x_items}}" class="form-control" placeholder="Unlimited usage" name="usage_limit_to_x_items" id="usage_limit_to_x_items">
                                        </div>
                                        <div class="col mb-3">
                                            <label for="booking">Usage limit per user</label>
                                            <input type="number" value="{{$discount->usage_limit_per_user}}" class="form-control" placeholder="Unlimited usage" name="usage_limit_per_user" id="usage_limit_per_user">
                                        </div>
                                    </div>
