                    ...
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form method="POST" action="{{ route('update_offering',['isAdmin' => true]) }}"
                                            ...
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="offering-content" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                                    <div class="my-4">
                                                        ...
                                                        <select id="booking-duration"
                                                                name="booking_duration_offering"
                                                                class="form-select">
                                                            <option
                                                    ...
                                                    <div class="row mb-4">
                                                        <div class="col-md-6">
                                                            ...
                                                            <select class="form-select"
                                                                    name="availability_type_offering"
                                                                    data-type="change"
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                <label for="service-hours"
                                                                       class="fw-bold">From</label>
                                                            ...
                                                            <div>
                                                                <label for="service-hours"
                                                                       class="fw-bold">To</label>
                                                                <input type="datetime-local" class="form-control"
                                                                       name="to_date_offering"
                                                                       placeholder=""
                                                                       value="{{ $offering->to_date }}">
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="tab-pane fade" id="event-content" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                                    <div class="my-4">
                                                        ...
                                                        <select id="specify" name="specify_event"
                                                                class="form-select"
                                                                data-type="change"
                                                    ...
                                                    <div
                                                        ...
                                                        <label for="service-hours" class="fw-bold">Date and
                                                            time</label>
                                                        <input type="datetime-local" class="form-control"
                                                               placeholder=""
                                                    ...
                                                    <div class="mb-4">
                                                        <div class="form-check offering-check">
                                                            <input type="checkbox" class="form-check-input ms-0"
                                                                   id="can-be-cancelled"
                                                                   data-type="hide"
                                                                   data-id="cancellation_time_event"
                                                    ...
                                                    <div class="form-check offering-check">
                                                        <input type="checkbox" class="form-check-input ms-0"
                                                               id="can-be-cancelled"
                                                               {{$offering->event?->is_confirmation ? 'checked' : ''}}
